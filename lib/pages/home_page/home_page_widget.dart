                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 16.0, 0.0, 0.0),
                                      child:
                                          StreamBuilder<List<PIXCreatedRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemBuilder:
                                              ...
                                              final listViewPIXCreatedRecord =
                                                  listViewPIXCreatedRecordList[
                                                      listViewIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                    ...
                                    Padding(
                                      ...
                                      child: StreamBuilder<List<KeyUserRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<KeyUserRecord>
                                              listViewKeyUserRecordList =
                                              snapshot.data!;
                                          return ListView.builder(
                                            padding: EdgeInsets.zero,
                                            shrinkWrap: true,
                                            scrollDirection: Axis.vertical,
                                            itemCount: listViewKeyUserRecordList
                                                .length,
                                            itemBuilder:
                                                (context, listViewIndex) {
                                              final listViewKeyUserRecord =
                                                  listViewKeyUserRecordList[
                                                      listViewIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
